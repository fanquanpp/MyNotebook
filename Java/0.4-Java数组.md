...
数组是Java中用于存储同一种数据类型多个元素的基本数据结构。
...
**原因分析：** 数组引用为null，或二维数组中的内层数组为null。
...
- [菜鸟教程 - Java数组](https://www.runoob.com/java/java-array.html)
