...
**英文名称**：Structured Query Language

**中文译名**：结构化查询语言

**缩写**：SQL

**出现位置**：C10_101-概述与环境.md 第3章
...
**英文名称**：Date and Time Types

**中文译名**：日期时间类型

**出现位置**：C10_105-数据类型与约束.md 第3章
...
**英文名称**：Isolation Level

**中文译名**：隔离级别

**出现位置**：G10_202-事务与锁.md 第2章
...
**英文名称**：Multi-Version Concurrency Control
...
**英文名称**：Storage Engine Comparison
...
**英文名称**：Database Normalization

**中文译名**：数据库规范化

**出现位置**：C10_104-控制器与应用.md 第1章
...
**英文名称**：Entity-Relationship Diagram
...
**英文名称**：Character Set / Collation

**中文译名**：字符集与排序规则

**出现位置**：C10_105-数据类型与约束.md 第6章
...
**英文名称**：Stored Procedure

**中文译名**：存储过程

**出现位置**：C10_104-控制器与应用.md 第2章
...
**英文名称**：Event Scheduler

**中文译名**：事件调度器

**出现位置**：C10_104-控制器与应用.md 第4章
