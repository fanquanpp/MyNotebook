...
| 03 | Python 脚本     | Python Scripting         | [./03-Python/README.md](./03-Python/README.md)         |
...
| 08 | JavaScript 脚本 | JavaScript               | [./08-Javascript/README.md](./08-Javascript/README.md) |
...
- [Python 脚本](./03-Python/README.md)
- [Java 后端开发](./04-Java/README.md)
- [JavaScript 脚本](./08-Javascript/README.md)
...
graph LR
    subgraph 基础工具
        A[Markdown] --> B[Git] --> C[GitHub]
    end
    
    subgraph Web前端
        D[HTML5] --> E[CSS] --> F[JS] --> G[TS] --> H[Vue3]
    end
...
### 7.2 命名规则
**完整格式**：`[类型代号][文件夹序号]_[文件序号]-[笔记内容].md`
...
| 文件夹序号 | 模块编号（2位数字，不足补0） | 01、02、...、16 |
| 文件序号 | 文件编号（3位数字） | 101、102、...、201、202、... |
| 笔记内容 | 文件主题描述（短横线分隔） | 账户及安全、配置与构建 |
...
| 专项知识点笔记 | Z | 特定领域的深入探讨和专题研究 | 301-399 |
| 算法与数据结构 | SFDE | 算法与数据结构相关的专业内容 | 301-399 |
| 名词注释查阅表 | V | 对应内容的专有名词的定义和概念的解释说明文档 | 无固定编号 |

### 7.4 排序规则
- **文件夹排序**：01、02、03……16（按模块重要性和学习顺序）
...
- **v3.4.0** (2026-05-02) - 优化 README.md 结构，细化文件命名规则和更新日志
- **v3.3.0** (2026-04-18) - 集成笔记文件命名策略到 README.md
- **v3.0.0** (2026-04-18) - 完成 GitHub 仓库 3.0 结构优化规划，统一文件命名规范
- **v2.5.10** (2026-04-18) - 更新 README.md 文件，确保包含最新的目录结构和信息
- **v2.5.8 ~ v2.5.9** (2026-04-08) - 补充多个优质 GitHub 仓库推荐
- **v2.5.5 ~ v2.5.7** (2026-04-07) - 优化 README.md 外部资源推荐部分
- **v2.5.1 ~ v2.5.4** (2026-04-06) - 重构项目根目录 README.md，优化结构和可读性
- **v2.5.0** (2026-04-05) - 全库重构完成
...
### 2026-04-18
- 升级版本至 v3.3.0 和 v3.0.0
- 集成笔记文件命名策略到 README.md，详细说明文件命名规则和代号系统
...
### 2026-04-07
- 升级版本至 v2.5.5 ~ v2.5.7
- 优化 README.md 外部资源推荐部分，从列表改为表格并按分类组织，提升可读性
