...
GitHub 平台完整教程：账户安全、远程协议、仓库管理、分支策略、PR/Issue、Actions、Pages、协作规范与排错。本教程与仓库内的 [07-Git版本控制](../07-Git版本控制/README.md) 形成互补关系，后者主要讲解 Git 命令与核心概念，而本教程则聚焦于 GitHub 平台的实战应用。
...
### 3.2 核心知识点 | Core Knowledge Points

- **账号与安全**：GitHub 账号体系与注册流程、2FA 配置、安全最佳实践、PAT 管理、密钥管理
- **SSH 与 HTTPS**：连接方式对比、密钥配置、认证方式、错误排查、多账号环境
- **仓库创建与管理**：仓库初始化、README 与 LICENSE 配置、权限管理、分支与标签管理

### 3.3 延伸阅读 | Further Reading

- [GitHub 官方文档](https://docs.github.com/)
- [Git 官方文档](https://git-scm.com/doc)
- [GitHub 技能认证](https://skills.github.com/)
