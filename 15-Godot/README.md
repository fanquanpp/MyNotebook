...
> **路径**：`15-Godot游戏引擎/` | **GDScript（Godot 脚本语言）** + **Godot（游戏引擎）**
...
- [V_15-Godot名词注释查阅表.md](./V_15-Godot名词注释查阅表.md)
...
- 本仓库：[03-Python](../03-Python/README.md)、[16-Renpy游戏引擎](../16-Renpy游戏引擎/README.md)

## 9. 关联章节 | Related Modules

- **Python（Python 语言）**：Godot 脚本可与 Python 思维对照 [`03-Python`](../03-Python/README.md)  
- **Ren'Py（视觉小说引擎）**：[`16-Renpy游戏引擎`](../16-Renpy游戏引擎/README.md)
