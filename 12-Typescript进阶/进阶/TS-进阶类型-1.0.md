...
在 tsconfig.json 中配置路径映射，简化导入路径。
...
- [jkchao/typescript-book-chinese](https://github.com/jkchao/typescript-book-chinese)<!-- nofollow -->

< a id="10"></a>
## 10 更新日志

- **2026-04-05**: 完善进阶类型详解，添加类型操作符、类型守卫和模块解析等内容。
